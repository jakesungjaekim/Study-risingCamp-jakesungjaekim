  ...
  return (
    <section className='w-screen px-10 pt-5'>
      <div className='flex w-full h-[78px]'>
        <div className='w-full md:min-w-[646.23px] lg:min-w-[843.23px] xl:min-w-[1099.23px] 2xl:px-20 2xl:min-w-[1279.23px] 3xl:w-full h-full bg-rose-50 transition duration-500'></div>
